...
<DIV class='title_line'>
  ...
  ${mainVO.main_name } > ${apiVO.api_name } >
  글 등록
</DIV>

<DIV class='content_body'>
  <ASIDE class="aside_right">
    <A href="./create.do?apino=${apiVO.api_no }">등록</A>
  ...
  <FORM name='frm' method='POST' action='./create.do' class="form-horizontal"
    ...
    <input type="hidden" name="main_no" value="${apiVO.main_no }"> 
    <input type="hidden" name="api_no" value="${param.api_no }">
    <input type="hidden" name="adminno" value="1"> <%-- 관리자 개발후 변경 필요 --%>
    
    <div class="form-group">
       <label class="control-label col-md-2">기술명</label>
       <div class="col-md-10">
         <input type='text' name='tech_name' value='제목' required="required" 
                   autofocus="autofocus" class="form-control" style='width: 70%;'>
       </div>
    </div>
    <div class="form-group">
       <label class="control-label col-md-2">기술 설명</label>
       <div class="col-md-10">
         <textarea name='contents' required="required" class="form-control" rows="12" style='width: 70%;'>내용</textarea>
       </div>
    </div>
    <div class="form-group">
       <label class="control-label col-md-2">검색어</label>
       <div class="col-md-10">
         <input type='text' name='word' value='검색어 입력' required="required" 
    ...
    <div class="form-group">
       ...
       <div class="col-md-10">
         <input type='file' class="form-control" name='file1MF' id='file1MF' 
                    value='' placeholder="파일 선택" style='width: 70%;'>
       </div>
    </div>   
    <div class="form-group">
