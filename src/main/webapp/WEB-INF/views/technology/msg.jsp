...
<DIV id='msg_title' style='text-align:center; margin-top:30px;'>알림</DIV>
    ...
    <UL class='msg_center'>
      <c:choose>
        ...
        <c:when test="${param.code == 'product_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>                                                   
            <button type='button' 
                         onclick="location.href='./product_update.do?api_no=${param.api_no}&main_no=${param.main_no }&techno=${param.techno }'"
        ...
        <c:when test="${param.code == 'create_success'}"> <%-- Java if --%>
          ...
          <LI class='li_none'>
            <button type='button' 
                         onclick="location.href='./create.do?api_no=${param.api_no}&main_no=${param.main_no }'"
      ...
      <LI class='li_none'>
        ...
        <%-- <a href="./list_by_cateno.do?cateno=${param.cateno}" class="btn btn-default">목록</a> --%>
        ...
        <button type='button' onclick="location.href='./list_technology.do?api_no=${param.api_no}'" class="btn btn-primary">목록</button>
